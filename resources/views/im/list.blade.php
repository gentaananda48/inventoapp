      ...
      <section class="section">
        ...
        <div class="card-body">
            ...
            <table class="table table-bordered table-md">
                ...
                {{-- Button --}}
                <td>
                    <form action="{{route('im.destroy', $data->id)}}" method="POST">
                        @csrf
                        @method('DELETE')
                        <button type="submit" class="btn btn-danger btn-md text-light">Hapus</button>
                        <a href="{{route('im.show',$data->id)}}" class="btn btn-success">Detail</a>
                      </form>
                    </td>
                </tr>
                @endforeach

                      ...
                      <div class="card">
                        ...
                        <div class="card-body">
                          ...
                          <div class="col-6" style="float: right;">
                            @if($data->jumlah == 0)
                            <form method="POST" action="{{route('purchasing.update', $data->id)}}" enctype="multipart/form-data">
                              @csrf
                              @method('PUT')
                            <input type="hidden" class="form-control" placeholder="Masukan jumlah barang" value="purchasingrequest" name="status">
                          <button type="submit" class="btn btn-success btn-md text-light">Ajukan Permintaan</button>
                            </form>
                          @endif
                          </div>
                      </div>

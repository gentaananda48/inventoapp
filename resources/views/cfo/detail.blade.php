                      ...
                      <div class="card">
                        ...
                        <div class="card-body">
                          ...
                          <div class="col-6" style="float: right;">
                            <div class="row">
                              <div class="col">
                            <form method="POST" action="{{route('cfo.update', $data->id)}}" enctype="multipart/form-data">
                              @csrf
                              @method('PUT')
                            <input type="hidden" class="form-control"value="available" name="status">
                            <input type="hidden" class="form-control"value={{$data->rencana_pesanan}} name="jumlah">
                          ...
                          <div class="col">
                            <form method="POST" action="{{route('cfo.update', $data->id)}}" enctype="multipart/form-data">
                              @csrf
                              @method('PUT')
                            <input type="hidden" class="form-control"value="reject" name="status">
